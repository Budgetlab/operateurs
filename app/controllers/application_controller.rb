...
class ApplicationController < ActionController::Base
  ...
  def set_global_variable
    ...
    @liste_familles = ['Affaires étrangères', "Agences de l'Eau", 'Agriculture hors formation', 'ARS', 'Aucune', 'Autres écoles', 'Blanchisseries', 'CANCEROPOLES', 'CARIF OREF','CDAD', "Chambres d'agriculture", 'Cité des Métiers', 'CPP', 'CTI', "Écoles d'art et d'architecture", 'Écoles fonction publique / militaires', "Ecoles Françaises à l'Etranger", 'Écoles Normales, Centrales, Ingénieurs, Chimie et Techniques', 'Écoles vétérinaires et agro', 'Emploi / travail', 'EPF et EPA et 50 pas', 'FCIP', 'Financeurs', 'Financeurs Culture', 'GRADES', 'IEP', 'Immobilier', 'Instituts nationaux des jeunes sourds ou aveugles et éducation inclusive', "Maisons de l’emploi", 'Maisons des adolescents', 'Musées', 'Œuvres universitaires et scolaires', 'OPCO', 'Organismes de recherche', 'Parcs nationaux', 'Patrimoine', 'Ports, grands ports maritimes et terminaux de croisière', 'Santé et Sécurité sociale', 'Soutien à l’enseignement supérieur et à la recherche', 'Théâtres, Spectacles et Opéra', 'Universités' ]
    ...
    @liste_approbation = @liste_approbation.sort
